...
for (r in 1 : replicas) {	# r = 1		# For testing
	...
	#   Newman, M. E. Assortative mixing in networks. Phys. review letters 89, 208701 (2002).
	...
	# ====================================================================================================================================
	# Simulate Reference Table for DMR model
	# ====================================================================================================================================
	...
	outputFileName	=	paste("DMR simul n = 300 NnodesTable = ", NnodesTable, " ", gsub("\\:", "_", round(end_time)), ".RData",sep='')
